...
class Metaclass_OddEvenCheck(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'udemy_ros2_pkg.srv.OddEvenCheck')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from udemy_ros2_pkg.srv import _odd_even_check
...
class OddEvenCheck(metaclass=Metaclass_OddEvenCheck):
    from udemy_ros2_pkg.srv._odd_even_check import OddEvenCheck_Request as Request
    from udemy_ros2_pkg.srv._odd_even_check import OddEvenCheck_Response as Response
